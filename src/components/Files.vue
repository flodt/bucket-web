    ...
    <section>
        ...
        <div class="fixed-action-btn">
            ...
            <ul>
                ...
                <li><a class="btn-floating green tooltipped" data-tooltip="Upload without clearing files..."
                       data-position="left" @click="onNoDeleteUpload"><i class="material-icons">file_upload</i></a></li>
                <!--<li><a class="btn-floating blue tooltipped" data-tooltip="Download all..." data-position="left"><i class="material-icons">file_download</i></a></li>-->
            </ul>
        </div>
    </section>
</template>
